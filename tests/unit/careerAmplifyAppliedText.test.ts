 ...
 *
 *  - a leading filler removal lowercased the bullet ("Successfully launched..." ->
 *    "launched...")
 *  - the quantification clause doubled sentence punctuation ("...runtime., reducing")
 *  - the verb-strength rule produced ungrammatical catenative constructions
 *    ("Led the support team resolve escalations.")
 *
 * Each bullet below is chosen to trip its corresponding defect if reintroduced.
 */
...
const RAW = [
  ...
  'Helped the support team.', // weak leading verb
].join('\n');
