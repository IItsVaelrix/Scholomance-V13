...
export const HEALTH_CODES = Object.freeze({
  ...
  // ─── TEMPORAL LAYER (animation-as-source-code) ──────────────────────────
  TEMPORAL_KEYFRAME_CURATED: 'PB-OK-v1-TEMPORAL-KEYFRAME-CURATED',
  TEMPORAL_INTERPOLATION_CERTIFIED: 'PB-OK-v1-TEMPORAL-INTERPOLATION-CERTIFIED',
  TEMPORAL_REPLAY_VERIFIED: 'PB-OK-v1-TEMPORAL-REPLAY-VERIFIED',
  TEMPORAL_DRIFT_DETECTED: 'PB-WARN-v1-TEMPORAL-DRIFT-DETECTED',
  TEMPORAL_ALGORITHM_UNKNOWN: 'PB-ERR-v1-TEMPORAL-ALGORITHM-UNKNOWN',
  TEMPORAL_DIMENSION_MISMATCH: 'PB-ERR-v1-TEMPORAL-DIMENSION-MISMATCH',
  TEMPORAL_APPROVAL_REQUIRED: 'PB-ERR-v1-TEMPORAL-APPROVAL-REQUIRED',
});
