...
async function main() {
  ...
  // Layer 0 is the voxel block (800 cells). Layer 1 is the flower (345 cells).
  ...
  // Apply Enhancements ONLY to the flower
  ...
  console.log(`Exported pure flower PNG to ${OUT_PNG}`);
  ...
  console.log(`Exported pure flower Aseprite to ${OUT_ASE}`);
}
