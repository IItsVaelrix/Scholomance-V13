...
async function main() {
  ...
  const outPath = '/home/deck/Downloads/Scholomance-V12-main/docs/references/VoidIceSunflower-AsepriteImported.png';
  ...
  console.log('Morphed to VoidIceSunflower-AsepriteImported.png');
}
