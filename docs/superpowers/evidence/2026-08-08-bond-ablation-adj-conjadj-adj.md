# Bond Ablation — +ADJ|CONJADJ|ADJ — 2026-08-08
...
|---|---|---|---|---|---|---|---|
| `+ADJ|CONJADJ|ADJ` | 83 | DEV | +7 | +8 | +6 | 0.10pp | 0.05pp |
| | | TEST | +7 | +13 | +7 | 0.08pp | 0.00pp |

## Repro

```bash
node scripts/bond-ablation.mjs --add ADJ,CONJADJ,ADJ,0
```
